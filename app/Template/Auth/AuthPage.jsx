    ...
    <section className="my-auto">
        ...
        <div className="flex w-full max-w-sm mx-auto bg-white rounded-xl shadow-xl">
            <div className="w-full px-6 py-8">
                ...
                <p className="mt-3 text-xl text-center text-sky">
                    {greeting}
                </p>
        
                <a href="#" className="flex items-center justify-center mt-4 text-sky transition-colors duration-300 transform border rounded-lg  hover:bg-fresh">
